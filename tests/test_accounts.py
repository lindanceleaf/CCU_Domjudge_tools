...
from create_accounts import generate_accounts, save_accounts, upload_accounts
...
class AccountTests(unittest.TestCase):
    ...
    def test_student_account_references_imported_team(self):
        ...
        self.assertEqual(generate_accounts(self.root)[0], {
    ...
    def test_ta_account_is_admin_without_explicit_team_id(self):
        ...
        account = generate_accounts(self.root)[0]
    ...
    def test_build_accounts_skips_invalid_rows_and_keeps_first_duplicate(self):
        ...
        with patch("builtins.print") as printer:
            accounts = generate_accounts(self.root)
    ...
    def test_write_accounts_writes_yaml_and_returns_destination(self):
        ...
        self.assertEqual(save_accounts(accounts, output_path), output_path)
    ...
    def test_upload_accounts_uses_v4_yaml_endpoint(self):
        ...
        save_accounts([], output_path)
        session = FakeSession(FakeResponse(200, "ok"))
        self.assertIsNone(upload_accounts(output_path, "https://judge.example", session))
